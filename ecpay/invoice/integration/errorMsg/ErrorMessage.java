package ecpay.invoice.integration.errorMsg;
...
public class ErrorMessage {
	...
	public final static String MInfo_UNDIFINED_TAG = "invoice_conf設定擋MInfo放入未定義的參數";
	
	public final static String OperatingMode_ERROR = "invoice_conf設定擋OperatingMode設定錯誤";
